...
`upozilla` varchar(45) DEFAULT NULL,
`district` varchar(45) DEFAULT NULL,
`mobile` varchar(45) DEFAULT NULL,
`trade` varchar(60) DEFAULT NULL,
`nationality` varchar(45) DEFAULT NULL,
`jscBoard` varchar(45) DEFAULT NULL,
`jscYear` varchar(45) DEFAULT NULL,
`jscRoll` varchar(45) DEFAULT NULL,
`jscResult` varchar(45) DEFAULT NULL,
`sscBoard` varchar(45) DEFAULT NULL,
`sscYear` varchar(45) DEFAULT NULL,
`sscRoll` varchar(45) DEFAULT NULL,
`sscResult` varchar(45) DEFAULT NULL,
`description` blob,
